...
export function DatePicker({ value, onChange, placeholder = "เลือกวันที่", min, max, className }: Props) {
      ...
      <PopoverTrigger
        render={
          <Button
            variant="outline"
            className={cn(
              "h-9 w-[160px] justify-start rounded-xl text-left text-sm font-normal",
              className,
            )}
          />
        }
